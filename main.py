...
class Node():
    ...
    def __repr__(self):
        return f"(Node {self.id}; remaining: cpu {self.remaining_cpu} mem {self.remaining_memory}; contaners: {len(self.containers_list)})"
...
class GeneticAlgorithm():
    ...
    def generate_solution(self):
        ref_dirs = get_reference_directions("das-dennis", 5, n_partitions=8)
