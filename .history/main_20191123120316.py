...
class GeneticAlgorithm():
    ...
    def crossover(self, p1, p2):  #p1 and p2 are of type Chromosome
        ...
        if rand_int == 1:
            child_node_ids = (p1.nodes[:crossover_point] +  #here could be problem with synchronization, as node should be passed by reference and not by instance
                     p2.nodes[crossover_point:]) 
        else:
            child_node_ids = (p2.nodes[crossover_point:] +
