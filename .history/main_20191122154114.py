...
def parse_arguments():
    ...
    return args.s, args.ms, args.ts, args.e, args.mg, args.mr

def main():
    population_size, mat_pool_size, tournament_size, elite_size, max_generations, mutation_rate = parse_arguments()
