...
class Chromosome():
    def __init__(self, node_ids, containers, nodes_info, rescheduling):
...
class GeneticAlgorithm():
    def __init__(self, population_size, mat_pool_size, tournament_size, elite_size, max_generations, mutation_rate, nodes_num, containers_num, nodes, containers, rescheduling):
    ...
    def generate_chromosome(self):
        ...
        chromosome = Chromosome(node_ids, containers, nodes_info, self.rescheduling)
        return chromosome
...
def generate_initial_placement():
        ...
        for i in range(len(containers)):
            if random.random() < 0.9: #with 90% probability assign conainer to node, not specified in paper
                ...
                node_ids.append(None)
        chromosome = Chromosome(node_ids, containers, nodes_info, True)
        return chromosome
...
def main():
    ...
    gen_algo = GeneticAlgorithm(population_size, mat_pool_size, tournament_size, elite_size, max_generations, mutation_rate, nodes_num, containers_num, rescheduling)
